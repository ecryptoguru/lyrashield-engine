...
- When evaluating severity, rely on direct, reproducible provider responses or supplied versioned evidence to confirm takeover prevention such as ownership verification or reserved-hostname protections; missing evidence is not evidence that the provider prevents claiming
