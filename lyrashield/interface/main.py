...
BEDROCK_EXTRA_HINT = (
    'Bedrock support is optional. Install it with: pipx install "lyrashield-engine[bedrock]"'
)
VERTEX_MODEL_MARKER = "vertex"
VERTEX_MISSING_MODULE_ERROR = "No module named 'google"
VERTEX_EXTRA_HINT = (
    'Vertex AI support is optional. Install it with: pipx install "lyrashield-engine[vertex]"'
)
...
def display_completion_message(args: argparse.Namespace, results_path: Path) -> None:
    ...
    console.print()
    console.print(
        "[#60a5fa]lyrashieldai.com[/]  [dim]·[/]  "
        "[#60a5fa]https://lyrashieldai.com/docs[/]  [dim]·[/]  "
        "[#60a5fa]https://lyrashieldai.com/support[/]"
    )
    console.print()
