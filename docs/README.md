...
3. [CONTRIBUTING.md](../CONTRIBUTING.md) for changes and verification. Engine CI enforces the same quality gates as pre-commit (Ruff, Mypy, Bandit, pytest) on every pull request.
