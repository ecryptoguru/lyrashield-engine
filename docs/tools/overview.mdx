---
title: "Agent Tools"
description: "Sandbox tools available to engine agents"
---

Engine agents can use specialized tools inside the reviewed sandbox while analyzing an authorized target.

<Warning>
Tool availability is capability, not proof that every tool ran or covered every path. The application records actual scanner coverage and limitations separately.
</Warning>
