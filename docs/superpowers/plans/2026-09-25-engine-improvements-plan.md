...
| Worker consumer contract | Passed locally | Exact merged product consumer `045cee3ca475a7216d05fb9f02f87f34c5002ef6` (product PR #790), 398 tests passed. Cloud and Desktop select engine implementation `21ce6688b8bc39c88822a0e1792b9be08dca8a07`. The reverse-pin update changes no engine runtime code. Production promotion and signed Desktop publication remain separate gates. |
