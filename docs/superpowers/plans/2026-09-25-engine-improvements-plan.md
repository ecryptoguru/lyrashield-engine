...
| Worker consumer contract | Passed locally | Exact merged product consumer `0f87d24b6ba10a31c6fe7dc2870cd727ee92ad61` (product PR #791), 398 tests passed. Cloud and Desktop select engine implementation `21ce6688b8bc39c88822a0e1792b9be08dca8a07`. The reverse-pin update changes no engine runtime code. Product `045cee3ca475a7216d05fb9f02f87f34c5002ef6` passed production promotion; the later product change is an E2E test fix. Signed Desktop publication remains a separate gate. |
