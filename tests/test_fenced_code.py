...
# Everything above is part of the base install; only `_strip_code_fence` lives
# behind the optional `viewer` extra. Gate that one import so the rest of this
# module still runs on a base (worker) install.
requires_viewer_extra = pytest.mark.skipif(
